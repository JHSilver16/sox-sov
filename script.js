...
const nomineesData = [
    {
        ...
        preview: "A young man devoted to serving his hometown of Lake Sebu, he provides free access to books, literacy programs, and cultural workshops that nurture learning and preserve T’boli heritage.",
        summary: "Michael’s journey in volunteerism began in 2003 with a simple dream—to create a safe space for children to learn—which blossomed into the T’boli Community Library and Community Hub, the first of its kind in Region XII. From a few donated books, it grew into a vibrant center offering free access to reading materials, literacy programs, and cultural workshops that celebrate and preserve T’boli heritage. His compassion extends beyond the library through initiatives like We Care, We Share, which provides school supplies and meals, and Layag Hendon, which brings solar lights to remote sitios. As a mentor in the Lake Sebu Youth Network, Michael continues to inspire young leaders to serve their communities. His story is a testament to how small acts of kindness can spark lasting change—rooted in culture, driven by compassion, and dedicated to uplifting others.",
        gallery: [
        ...
        socials: [{link:"https://www.facebook.com/LakeSebuYouthNetwork", name:"Lake Sebu Youth Network Inc."}, 
         ...
         news: [{link:"https://www.sunstar.com.ph/davao/feature/the-cultural-work-of-michael-angelo-yambok#google_vignette", 
            ...
            {link: "https://mirror.pia.gov.ph/features/2023/10/19/taking-center-stage-south-cotabatos-helobung-community-dance-troupe-tours-the-us?fbclid=IwY2xjawNIRxFleHRuA2FlbQIxMABicmlkETE0VDkwdVBRUjVEMXBPczNlAR4gsHMPBUsETSZ-QGcZF-67xkKnfU1ODvaEfhu67L7zhlG_tByAi5EPbSTqhA_aem_K53afdcL7zWzv9NRiIkdkg", 
             name:"Taking Center Stage: South Cotabato’s Helobung Community Dance Troupe tours the U.S."}],
    ...
    
    {
        ...
        socials: [{link:"https://drive.google.com/file/d/1vBwDU6BWJw0LxIvZ0pcMhqExv2D-uLc5/view?usp=drive_link", name: "KESTEFUN: a praise jam"},
         ...
         news: [{link:"https://www.facebook.com/story.php?story_fbid=186303200482547&id=100077297347949&rdid=GHJ3JiLORysFkZe7#", name:"𝑩𝑨𝑯𝑨𝑩𝑰: 𝑩𝑹𝑰𝑮𝑨𝑫𝑨 𝑷𝑨𝑮𝑩𝑨𝑺𝑨 in Lake Sebu"}],
